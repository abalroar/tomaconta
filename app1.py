...
if menu == "Sobre":
    ...
    if _garantir_dados_principais("Rankings"):
        ...
        indicadores_config = {
            ...
            'Patrimônio Líquido': ['Patrimônio Líquido'],
            'Índice de Capital Principal (CET1)': ['Índice de Capital Principal (CET1)', 'Índice de Capital Principal'],
            'Índice Capital T1': ['Índice de Capital Nível I', 'Índice Capital Nível I', 'Índice de Capital Nivel I', 'Índice Capital T1'],
            'Índice de Basileia (%)': ['Índice de Basileia'],
            'Lucro Líquido Acumulado YTD': ['Lucro Líquido Acumulado YTD'],
            'Lucro Líquido Trimestral': ['Lucro Líquido Trimestral'],
        ...
        if not indicadores_disponiveis:
            ...
            _RANKINGS_GLOSSARIO = {
                ...
                'Índice Capital T1': 'Patrimônio de Referência Nível I ÷ RWA Total. Equivale a (CET1 + AT1) ÷ RWA Total.',
            ...
            if grafico_base == "Deltas (antes e depois)":
                ...
                periodos_delta_ordenados = ordenar_periodos(periodo_resumo, reverso=True)
                periodo_subsequente_delta = periodos_delta_ordenados[0] if periodos_delta_ordenados else None
                periodo_inicial_delta = periodos_delta_ordenados[-1] if periodos_delta_ordenados else None
                periodo_valido = (
                    bool(periodo_inicial_delta)
                    and bool(periodo_subsequente_delta)
